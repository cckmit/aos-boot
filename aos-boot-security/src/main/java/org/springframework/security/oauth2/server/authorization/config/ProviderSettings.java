...
public final class ProviderSettings extends AbstractSettings {
    ...
    private static final String pre = "/ap";
    ...
    public static Builder builder() {
        return new Builder()
                .authorizationEndpoint(pre + "/oauth2/authorize")
                .tokenEndpoint(pre + "/oauth2/token")
                .jwkSetEndpoint(pre + "/oauth2/jwks")
                .tokenRevocationEndpoint(pre + "/oauth2/revoke")
                .tokenIntrospectionEndpoint(pre + "/oauth2/introspect")
                .oidcClientRegistrationEndpoint(pre + "/connect/register")
                .oidcUserInfoEndpoint(pre + "/userinfo");
    }
